  ...
  return (
    <div className="flex rounded-md justify-between p-5 bg-white shadow-md">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Info */}
        <div>
          <h2 className="text-lg text-[#232323] font-semibold">
           {orgName}
          </h2>
      ...
      <div className="">
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2.5 px-2 py-1 bg-green-50 rounded-full cursor-pointer">
            <span className="w-2 h-2 bg-[#12BB23] rounded-full"></span>
            <span className="text-xs text-[#12BB23] font-medium">Active</span>
          </div>
          <button className="mt-2 text-xs text-[#6834FF] cursor-pointer">Change status</button>
        </div>
      </div>
    </div>
  );
